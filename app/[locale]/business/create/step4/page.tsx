...
export default function CreateBusinessStep4() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Submit claim request instead of creating business directly
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-black mb-8">
                  لقد أرسلنا لك رسالة نصية تحتوي على رمز تحقق مكون من 6 أرقام
                  <br />
                ...
                <div className="mb-6">
                  ...
                  >
                    لم يصل بعد؟{" "}
                    <span className="font-bold">إعادة إرسال الكود</span>
                  </button>
                </div>
