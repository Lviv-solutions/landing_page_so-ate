...
export default function CreateBusinessStep1() {
  ...
  const handleNext = async () => {
    ...
    if (!formData.arName || !formData.phoneNumber || !formData.categoryId) {
      alert("الرجاء إكمال جميع الحقول المطلوبة (الاسم، رقم الهاتف، الفئة)");
      return;
    }
                ...
                <div className="space-y-4">
                  <div>
                    <h2 className="text-2xl font-bold text-black mb-2">
                      سجل بيانات مطعمك الأساسية
                    </h2>
                    <p className="text-sm text-black leading-relaxed mb-6">
                      قم بإضافة معلومات البيزنس الخاص بك بالتفصيل. صفحة البيزنس
                      الخاص بك لن يتم التحقق من هذه المعلومات من الآخرين، بحيوث
                      بالواقعية عليها سيرسل لك بريد الكتروني يوضح لك تفاصيل ربط
                      البيزنس الخاص بك.
                    </p>
                  </div>
