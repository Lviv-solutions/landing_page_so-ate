...
depth, render, hasChild, slotProps, className, externalLink, enabledRootRedirect, ...other }) {
    ...
    return (_jsxs(ItemRoot, { "aria-label": title, ...ownerState, ...navItem.baseProps, className: mergeClasses([navSectionClasses.item.root, className], {
        ...
        }), sx: slotProps?.sx, ...other, children: [icon && (_jsx(ItemIcon, { ...ownerState, className: navSectionClasses.item.icon, sx: slotProps?.icon, children: navItem.renderIcon })), title && (_jsx(ItemTitle, { ...ownerState, className: navSectionClasses.item.title, sx: slotProps?.title, children: title })), caption && (_jsx(Tooltip, { title: caption, arrow: true, placement: "right", children: _jsx(ItemCaptionIcon, { ...ownerState, icon: "eva:info-outline", className: navSectionClasses.item.caption, sx: slotProps?.caption }) })), info && navItem.subItem && (_jsx(ItemInfo, { ...ownerState, className: navSectionClasses.item.info, sx: slotProps?.info, children: navItem.renderInfo })), hasChild && (_jsx(ItemArrow, { ...ownerState, icon: "eva:arrow-ios-forward-fill", className: navSectionClasses.item.arrow, sx: slotProps?.arrow }))] }));
}
