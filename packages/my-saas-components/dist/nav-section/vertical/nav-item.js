...
depth, render, hasChild, slotProps, className, externalLink, enabledRootRedirect, ...other }) {
    ...
    return (_jsxs(ItemRoot, { "aria-label": title, ...ownerState, ...navItem.baseProps, className: mergeClasses([navSectionClasses.item.root, className], {
        ...
        }), sx: slotProps?.sx, ...other, children: [icon && (_jsx(ItemIcon, { ...ownerState, className: navSectionClasses.item.icon, sx: slotProps?.icon, children: navItem.renderIcon })), title && (_jsxs(ItemTexts, { ...ownerState, className: navSectionClasses.item.texts, sx: slotProps?.texts, children: [_jsx(ItemTitle, { ...ownerState, className: navSectionClasses.item.title, sx: slotProps?.title, children: title }), caption && (_jsx(Tooltip, { title: caption, placement: "top-start", children: _jsx(ItemCaptionText, { ...ownerState, className: navSectionClasses.item.caption, sx: slotProps?.caption, children: caption }) }))] })), info && (_jsx(ItemInfo, { ...ownerState, className: navSectionClasses.item.info, sx: slotProps?.info, children: navItem.renderInfo })), hasChild && (_jsx(ItemArrow, { ...ownerState, icon: open ? 'eva:arrow-ios-downward-fill' : 'eva:arrow-ios-forward-fill', className: navSectionClasses.item.arrow, sx: slotProps?.arrow }))] }));
}
