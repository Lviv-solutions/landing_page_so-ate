...
export function AnimateCountUp({ to, sx, from = 0, toFixed = 0, once = true, duration = 2, amount = 0.5, unit: unitProp, component = 'p', ...other }) {
    ...
    return (_jsxs(Typography, { component: component, sx: [
        ...
        ], ...other, children: [_jsx(m.span, { ref: countRef, children: rounded }), unit] }));
}
// ----------------------------------------------------------------------
function isFloat(n) {
