...
export function CustomPopover({ open, onClose, children, anchorEl, slotProps, ...other }) {
    ...
    return (_jsxs(Popover, { "aria-hidden": !open, open: !!open, anchorEl: anchorEl, onClose: onClose, anchorOrigin: anchorOrigin, transformOrigin: transformOrigin, slotProps: {
            ...otherSlotProps,
            paper: {
                ...paperProps,
        ...
        }, ...other, children: [isArrowVisible && (_jsx(Arrow, { size: arrowSize, placement: arrowPlacement, paperRect: paperRect, anchorRect: anchorRect, sx: arrowProps?.sx })), children] }));
}
