...
export function CarouselProgressBar({ sx, value, className, ...other }) {
    return (_jsx(ProgressBarRoot, { className: mergeClasses([carouselClasses.progress.root, className]), sx: [{ '--progress-value': value }, ...(Array.isArray(sx) ? sx : [sx])], ...other, children: _jsx(ProgressBar, { className: carouselClasses.progress.bar }) }));
}
// ----------------------------------------------------------------------
