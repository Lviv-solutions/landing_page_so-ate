...
export function Carousel({ sx, carousel, children, slotProps, className, ...other }) {
    ...
    return (_jsx(CarouselRoot, { sx: sx, ref: mainRef, axis: axis, className: mergeClasses([carouselClasses.root, className]), ...other, children: _jsx(CarouselContainer, { axis: axis, slideSpacing: slideSpacing, className: carouselClasses.container, sx: [
                (theme) => ({
