...
export type CarouselDotButtonsProps = BoxProps<'ul'> & Omit<UseCarouselDotsReturn, 'dotCount'> & {
    gap?: number;
...
export type CarouselArrowButtonsProps = React.ComponentProps<'div'> & UseCarouselArrowsReturn & {
    sx?: SxProps<Theme>;
    totalSlides?: number;
    selectedIndex?: number;
...
export type CarouselProgressBarProps = React.ComponentProps<'div'> & UseCarouselProgressReturn & {
    sx?: SxProps<Theme>;
};
/**
 * Autoplay
