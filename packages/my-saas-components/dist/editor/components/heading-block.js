...
export function HeadingBlock({ editor, isActive }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs(ButtonBase, { ...buttonProps, onClick: onOpen, sx: (theme) => ({
                    px: 1,
                    width: 120,
                    height: 32,
                    borderRadius: 0.75,
                ...
                }), children: [selectedOption?.label ?? 'Paragraph', _jsx(Iconify, { width: 16, icon: open ? 'eva:arrow-ios-upward-fill' : 'eva:arrow-ios-downward-fill' })] }), _jsx(Menu, { id: menuId, anchorEl: anchorEl, open: open, onClose: onClose, slotProps: {
                ...
                }, children: HEADING_OPTIONS.map((option) => (_jsx(ToolbarItem, { component: "li", "aria-label": option.label, label: option.label, active: isActive(option.level), onClick: () => handleSelect(option.level), sx: {
                        ...(option.level && {
